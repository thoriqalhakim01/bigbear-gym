...
export function getErrorInfo(errorMessage: string): ErrorInfo {
    ...
    const errorInfoMap: Record<ErrorType, Omit<ErrorInfo, 'type'>> = {
        ...
        [ErrorType.MEMBER_NOT_FOUND]: {
            ...
            description: 'This RFID card is not registered in our system',
            icon: UserPlus,
            nextSteps: [
                ...
                'Ensure you are using the correct RFID card',
            ],
            isRetryable: false,
            severity: 'error',
        },
        ...
        [ErrorType.INVALID_RFID]: {
            title: 'Invalid RFID Card',
            description: 'Please scan a valid RFID card',
            icon: RefreshCw,
            nextSteps: [
                'Make sure you are using the correct RFID card',
        ...
        [ErrorType.UNKNOWN_ERROR]: {
            ...
            nextSteps: [
                ...
                'Make sure your RFID card is properly activated',
                'Check if you are using the correct RFID card',
