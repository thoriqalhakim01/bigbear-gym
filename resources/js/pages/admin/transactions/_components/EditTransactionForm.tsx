...
export default function EditTransactionForm({ members, packages, transaction }: Props) {
    ...
    return (
        <form onSubmit={submit} className="w-full space-y-6">
            ...
            <div className="flex gap-4">
                ...
                <Button type="button" variant="outline" onClick={handleReset} disabled={processing} tabIndex={7}>
                    Reset
                </Button>
            </div>
        </form>
